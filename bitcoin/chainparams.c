...
const struct chainparams networks[] = {
    ...
    {.index = 4,
     ...
     .testnet = true},
    {.index = 5,
     .network_name = "mktcoin",
     .bip173_name = "mc",
     .genesis_blockhash = {{{.u.u8 = {0xce, 0xd5, 0xfc, 0x5c, 0xc0, 0x27, 0x71, 0x16, 0x5b, 0xbf, 0x09, 0x3d, 0x54, 0xed, 0x02, 0x3d, 0x24, 0xba, 0x88, 0xc5, 0x1c, 0xad, 0xaa, 0xe0, 0x3f, 0xf9, 0x0a, 0x5b, 0x70, 0xae, 0xbc, 0xdc }}}},
     .rpc_port = 9276,
     .cli = "mktcoin-cli",
     .cli_args = NULL,
     .dust_limit = 100000,
     ...
     .testnet = false},
    {.index = 6,
     .network_name = "mktcoin-testnet",
     .bip173_name = "tm",
     .genesis_blockhash = {{{.u.u8 = { 0x75, 0xee, 0x97, 0x36, 0x36, 0x36, 0xe0, 0x48, 0x03, 0xdf, 0xef, 0x56, 0xda, 0x17, 0xac, 0x13, 0x4e, 0x9c, 0xa3, 0x4f, 0x88, 0xc2, 0xf2, 0x0d, 0xd6, 0xec, 0xb1, 0xbe, 0x8e, 0x20, 0x7b, 0x24 }}}},
     .rpc_port = 19276,
     .cli = "mktcoin-cli",
     .cli_args = "-datadir=/home/server/.mktcoin-tn", /* set your own data dir if applicable */
     .dust_limit = 100000,
     .when_lightning_became_cool = 1,
     .testnet = true}
};
